...
<?php endif; ?>
<?php $component->withAttributes(['icon' => $icon,'internal' => true,'class' => \Illuminate\Support\Arr::toCssClasses([$customization['icon-spacing.left'] => $position === 'left', $customization['icon'], $colors['icon']])]); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\DynamicComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => $icon,'internal' => true,'class' => \Illuminate\Support\Arr::toCssClasses([$customization['icon-spacing.right'] => $position === 'right', $customization['icon'], $colors['icon']])]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH D:\pwebif\dona-cake-web\vendor\tallstackui\tallstackui\src/resources/views/components/badge/main.blade.php ENDPATH**/ ?>