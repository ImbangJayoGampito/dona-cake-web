...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['offset','position']));
...
foreach (array_filter((['offset','position']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = TallStackUi\Components\Floating\Component::resolve(['offset' => $offset,'position' => $position] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
 ...
 <?php $__env->slot('transition', null, []); ?> <?php echo e($transition); ?> <?php $__env->endSlot(); ?>
<?php echo e($slot ?? ""); ?>
...
<?php endif; ?><?php /**PATH D:\pwebif\dona-cake-web\storage\framework\views/85ca54c894252243e3513df07c59c71c.blade.php ENDPATH**/ ?>