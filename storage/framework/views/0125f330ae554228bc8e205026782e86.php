...
<?php endif; ?>
<?php $component->withAttributes(['icon' => $icon,'attributes' => $wireable['icon'],'internal' => true,'class' => \Illuminate\Support\Arr::toCssClasses([$customization['icon.sizes.' . $size], $colors['icon']])]); ?>
...
<?php endif; ?>
<?php else: ?>
    <span <?php if($livewire && $loading): ?>
        <?php echo e($wireable['text']); ?>

            <?php endif; ?> class="<?php echo \Illuminate\Support\Arr::toCssClasses([$customization['text.sizes.' . $size]]); ?>"><?php echo e($text ?? $slot); ?></span>
...
<?php /**PATH D:\pwebif\dona-cake-web\vendor\tallstackui\tallstackui\src/resources/views/components/button/circle.blade.php ENDPATH**/ ?>