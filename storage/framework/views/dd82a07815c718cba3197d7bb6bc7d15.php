...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['icon','invalidate']));
...
foreach (array_filter((['icon','invalidate']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = TallStackUi\Components\Form\Input\Component::resolve(['icon' => $icon,'invalidate' => $invalidate] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH D:\pwebif\dona-cake-web\storage\framework\views/ebce4ee67730805810284df5af5c880f.blade.php ENDPATH**/ ?>